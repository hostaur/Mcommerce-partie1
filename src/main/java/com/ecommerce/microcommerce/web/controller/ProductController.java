...
public class ProductController {
	...
	public Map<Object, Integer> calculerMargeProduit() {
		...
		produits.forEach(produit -> {
			...
			map.put(produitFiltres.getValue(), produit.getPrix() - produit.getPrixAchat());
    ...
    public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
		if (product.getPrix() == 0)
			throw new ProduitGratuitException("Le produit ne peut être enregistrer avec un prix de 0");
